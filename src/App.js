...
function App() {
  ...
  const endTime = new Date("2023-05-27T12:00:00Z");
  ...
  const [feedback, setFeedback] = useState(`Click to mint your FUNKOZ.`);
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              FUNKOZ merges the charm of whimsical, hand-drawn confections with the power of next-generation technology.
            </s.TextDescription>
